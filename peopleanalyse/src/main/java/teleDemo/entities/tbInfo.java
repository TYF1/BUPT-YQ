...
public class tbInfo implements Serializable{
    ...
    public tbInfo(int id, int asu, String cid, Date dateTime, Time time, int dbm, String lac, double lat, double lon, int userId, String netSpeed, int unreadSms, int wifiCount, String wifiInfo){
        this.id=id;
        this.asu=asu;
        this.cid=cid;
