...
public class UpdateRiskArea{
    ...
    public void UpdateHelper(teleDemo.mapper.comInfoMapper comInfoMapper, teleDemo.mapper.userInfoMapper userInfoMapper) {
        this.cnt = 0;
    ...
    public int updateUserInfo(int id, String ASTATUS) {
        ...
        if(hasUpdate.contains(id)){
            String areaState = comInfoMapper.selectUserStatus(id);
