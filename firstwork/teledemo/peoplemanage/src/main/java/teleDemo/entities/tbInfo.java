...
public class tbInfo implements Serializable{
    ...
    public tbInfo(int id, int asu, String cid, Date dateTime, int dbm, String lac, double lat, double lon, int userId, String netSpeed, int unreadSms, int wifiCount, String wifiInfo,String ASTATUS){
        this.id=id;
        this.asu=asu;
        this.cid=cid;
